                    ...
                    <div class="col-lg-12">
                        <div class="step" id="step2">
                            ...
                            <div class="alert alert-info alert-dismissible fade show" role="alert">
                                <strong>Pengumuman!</strong>Jika Kabupaten, Kota, Desa tidak muncul pilihannya. Pilih
                                Provinsi lain
                                untuk mentrigger.
                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" min="1" max="20"
                                            id="childPosition" name="child_position" required />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" min="1" max="20"
                                            id="childNumber" name="child_number" required />
                            ...
                            <div class="row" id="studentAddressRow">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="student_province_name" name="student_province_name"
                                            readonly />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="student_regency_name" name="student_regency_name"
                                            readonly />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="student_district_name" name="student_district_name"
                                            readonly />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="student_village_name" name="student_village_name"
                                            readonly />
                                    </div>
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg">
                            <div class="form-group">
                                ...
                                <input type="textarea" class="form-control" id="addressParent" name="address"
                                    required />
                                @if ($errors->has('address'))
                                    <p class="text-danger">{{ $errors }}</p>
                                @endif
        ...
        <form action="{{ route('ppdb.store') }}" id="enrollmentForm" method="post">
            ...
            <div class="step" id="step2">
                ...
                <div class="row mb-3">
                    ...
                    <!-- Bagian Address -->
                    <div class="row mb-3" id="studentAddressRow">
                        <div class="col">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="province">Provinsi:</label>
